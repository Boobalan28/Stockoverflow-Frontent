...
const Question = (params) => {
    ...
    useEffect(() => {
        Axios.get(`https://stockoverflowclone-api.herokuapp.com/questions/get/${params.match.params.questionId}`)        
        .then(res => {
    ...
    const postAnswer = e => {
        e.preventDefault();
        const token = new Cookies().get('token')
        Axios.post(`https://stockoverflowclone-api.herokuapp.com/questions/answer`, {token, answer: inputAnswer, answerer: userInfo.email, question: question._id})
        .then(res => {
